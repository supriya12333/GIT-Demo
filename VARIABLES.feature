...
@outline
Scenario Outline:
CSV Examples: Datasets/file2.csv
Given I echo <num1>
And I echo <num2>
...
@csv
Scenario:
Given I "write the file"
Given I assign "Datasets\file4.csv" to variable "filepath1"
If I verify file $filepath1 exists
Else I create file $filepath1
Endif

@replace
Scenario:
Given I assign "20" to variable "v2" 
Then I replace variables in string $v2 and store as variable "v3"
And I echo $v3
